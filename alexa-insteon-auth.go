...
func foo(w http.ResponseWriter, r *http.Request) {
	...
	if l.Request.Intent.Name == "Register" {
		var m Card
		url := "http://connect.insteon.com/api/v2/oauth2/auth?client_id=" + client_id + "&state=" + userid + "&response_type=code&redirect_uri=http://veryoblivio.us:9001/"
		m.Type = "Simple"
